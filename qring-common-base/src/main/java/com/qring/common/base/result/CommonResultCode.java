...
public class CommonResultCode extends ResultCode {
    ...
    public static final CommonResultCode SYSTEM_ERROR = new CommonResultCode(101, "System error");
    public static final CommonResultCode BUSINESS_ERROR = new CommonResultCode(102, "Business abnormalities, please try again later");
